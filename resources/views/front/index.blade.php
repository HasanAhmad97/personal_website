...
{{-- <div class="col px-0 text-start" style="line-height:1.8">
    ما هي المراحل التي تمر بها حتى تخرج تطبيقاتك ؟
    </div>
    ...
    <div id="collapseExample1" class="collapse" aria-labelledby="headingOne1" style="">
    <div class="card-body naskh border-top border-0 font-2 optimize-fonts" style="line-height:1.8;text-align:justify;"><p>لقد تعلمت الكثير من الدراسة الجامعية .<br>أحد هذه التعاليم هو مراحل تطوير أي نظام &nbsp;.<br>وهو كالتالي .</p><h6>1- تجميع المعلومات&nbsp;</h6><h6>2- تحليل النظام</h6><h6>3- مرحلة التصميم</h6><h6>4- مرحلة التنفيذ</h6><h6>5- مرحلة الإختبار</h6><h6>6- مرحلة الاطلاق</h6><h6>7- مرحلة المتابعة وإصلاح المشكلات</h6>
    </div>
    </div>
    </div>
    </div>
...
<div class="col-12 p-0">
    ...
    <div class="col-12 px-0">
    <div class="card px-1  mb-2">
    <div class="card-header border-0 btn  px-2 py-1" id="headingOne1" style="background: var(--bg-second-bg);" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1">
    <h5 class="mb-0">
    <span class="row d-flex col-12 kufi font-lg-2 font-1 p-2" style="color: var(--bg-color-0)!important">
    <div class="col px-0 text-start" style="line-height:1.8">
    ما هي المراحل التي تمر بها حتى تخرج تطبيقاتك ؟
    ...
    <div id="collapseExample1" class="collapse" aria-labelledby="headingOne1" style="">
    <div class="card-body naskh border-top border-0 font-2 optimize-fonts" style="line-height:1.8;text-align:justify;"><p> لقد تعلمت الكثير من الدراسة الجامعية والعمل على المشاريع.<br>أحد هذه التعاليم هو مراحل تطوير أي نظام &nbsp;.<br>وهو كالتالي .</p><h6>1- تجميع المعلومات&nbsp;</h6><h6>2- تحليل النظام</h6><h6>3- مرحلة التصميم</h6><h6>4- مرحلة التنفيذ</h6><h6>5- مرحلة الإختبار</h6><h6>6- مرحلة الاطلاق</h6><h6>7- مرحلة المتابعة وإصلاح المشكلات</h6>
    </div>
    </div>
    </div>
    </div>
